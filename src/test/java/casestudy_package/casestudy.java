...
public class casestudy {
	...
	public void BT()
	{
		...
		extent = new ExtentReports(System.getProperty("user.dir")+"//test-output//dev.html");
	...
	{
		driver.findElement(By.xpath("//*[@id='login']")).sendKeys("devudevu123");
		driver.findElement(By.xpath("//*[@id='password']")).sendKeys("devu@123");
	...
	public void Courses() throws InterruptedException
	{
		...
		Thread.sleep(2000);
		logger.log(LogStatus.PASS,"Course catalog openned");
